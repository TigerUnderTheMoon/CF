...
- [x] Manuscript PDF compiled from `final_source/manuscript.tex` after the structural stress-test, Countries-KG pilot, and MuSiQue compression revisions.
...
- [x] Manuscript page count is content-faithful to the cleanly compiled source after the current evidence-boundary revision: `manuscript.pdf` 20 pages (project-specific 12--25 page quality gate, not a journal rule; KBS imposes no hard page limit).
