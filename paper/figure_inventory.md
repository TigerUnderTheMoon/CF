...
All paths below refer to existing files under `outputs/figures/` unless status is marked pending. No figure descriptions are invented beyond the filename, source phase, and report placement.

Captions must describe stored outputs, metrics, perturbation settings, observed trace behavior, or measured pipeline outputs. Captions must not imply causal identification, mechanism recovery, structural explanation, or protocol-independent reasoning.
...
| `outputs/figures/minimal_subset_curve.png` | available | Phase 5 attribution | Plots minimal subset compression curve. | Appendix |
| `outputs/figures/redundancy_heatmap.png` | available | Phase 5 attribution | Visualizes Phase 5 redundancy report structure. | Appendix |
| `outputs/figures/faithfulness_scatter.png` | available | Phase 5 attribution | Plots Phase 5 attribution faithfulness scatter. | Appendix |
| `outputs/figures/attribution_utility_scatter.png` | available | Phase 4/5 validity | Plots attribution and utility relation. | Appendix |
| `outputs/figures/utility_distribution.png` | available | Phase 4 validity | Reports utility distribution. | Appendix |
| `outputs/figures/utility_by_category.png` | available | Phase 4 validity | Reports utility by taxonomy category. | Appendix |
| `outputs/figures/degradation_heatmap.png` | available | Phase 4 validity | Visualizes degradation diagnostics. | Appendix |
| `outputs/figures/category_dist.png` | available | Phase 4 validity | Reports category distribution. | Appendix |
...
| `outputs/figures/motif_frequency.png` | available | Phase 6 SRA | Reports motif frequency. | Appendix |
| `outputs/figures/compression_curve.png` | available | Phase 6 SRA | Plots structural compression curve. | Appendix |
| `outputs/figures/structural_influence_distribution.png` | available | Phase 6 SRA | Reports structural influence distribution. | Appendix |
