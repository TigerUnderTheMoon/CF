# DKE Transfer Consistency Audit - Final Split

Date: 2026-07-04

Purpose: record the code/evidence-to-paper consistency check for the Data & Knowledge Engineering transfer package.

## Evidence Alignment

| Paper claim surface | Source artifact | Checked value | Status |
|---|---|---:|---|
| PRM800K annotation-order consistency | `outputs/real_task_v3_6_prm800k_hash/locked_validation_report.json` | 4,417 samples; 34,219 steps; `w_struct` Spearman 0.6113401179642559; raw local utility -0.07745914322519368 | aligned |
...
- The paper wording treats production deployment, online maintenance, and external transfer as outside the reported audit-prioritization evidence.
...
- PRM800K locked annotation-order evidence where `w_struct` is the primary real-data signal and Ridge is the closest SC-FMA approximation.
...
- Authoritative manuscript source: `paper/dke_submission/final_source/manuscript.tex`.
- Expected compiled manuscript artifact: `paper/dke_submission/final_package/manuscript.pdf`.
