...
REAL_TASK_V3_SMOKE_ONLY = "REAL_TASK_V3_SMOKE_ONLY"
V3_SMOKE_PASS = "V3_SMOKE_PASS"
V3_SMOKE_PASS_WITH_DISCLOSURES = "V3_SMOKE_PASS_WITH_DISCLOSURES"
V3_SMOKE_FAIL_INSUFFICIENT_TRACES = "V3_SMOKE_FAIL_INSUFFICIENT_TRACES"
V3_SMOKE_FAIL_INSUFFICIENT_SPANS = "V3_SMOKE_FAIL_INSUFFICIENT_SPANS"
V3_SMOKE_FAIL_SPARSE_SIGNAL_GSM8K = "V3_SMOKE_FAIL_SPARSE_SIGNAL_GSM8K"
V3_SMOKE_FAIL_SPARSE_SIGNAL_HOTPOTQA = "V3_SMOKE_FAIL_SPARSE_SIGNAL_HOTPOTQA"
V3_SMOKE_FAIL_COST = "V3_SMOKE_FAIL_COST"
V3_SMOKE_FAIL_GENERATION = "V3_SMOKE_FAIL_GENERATION"
V3_SMOKE_FAIL_REPLAY = "V3_SMOKE_FAIL_REPLAY"
...
V3_INTERVENTION_CONTRACT = {
    ...
    "replace_intervention_in_current_v3": False,
}
...
def main() -> None:
    ...
    if args.task_scope != REAL_TASK_V3_SMOKE_ONLY:
        raise RuntimeError(f"--task-scope must equal {REAL_TASK_V3_SMOKE_ONLY}")

    config = _load_config(args.config)
    output_dir = Path(args.output_dir or config.get("experiment", {}).get("output_dir", "outputs/real_task_v3"))
...
def build_v3_smoke_prefixes(
    ...
    for record in original_records:
        ...
        for span in spans[:V3_MAX_SCORED_SPANS_PER_TRACE]:
            ...
            prefix["replace_intervention_in_current_v3"] = False
...
def _stage_replay_chat(
    *,
    ...
    def _process_one(job: Mapping[str, Any]) -> tuple[dict[str, Any] | None, dict[str, Any]]:
        ...
        intervened["intervention_type"] = job.get("intervention_type", "DELETE")
        ...
        attempt = {
            ...
            "intervention_type": job.get("intervention_type", "DELETE"),
...
def _replay_prompt_template(original_template: str) -> str:
    """Adapt the generation prompt for replay with observable_prefix."""
    return (
        ...
        "Continue the trace from where it left off, including any remaining reflection blocks.\n\n"
        "Task type: {task_type}\n"
        "Question:\n{question}\n\n"
        "Partial trace so far:\n{observable_prefix}\n\n"
        "Continue from here. Include at least one reflection block. "
